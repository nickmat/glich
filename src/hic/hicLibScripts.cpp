...
glich::StdStrMap glich::hics_default_scripts = {
 ...
 "}\n"
 "grammar lit {\n"
 "name \"Christian Liturgical\";\n"
 "fields year lweek wsday month day;\n"
 "rank year lweek wsday;\n"
 "lexicons ws m lit;\n"
 "alias pseudo { dw wsday; ww lweek; yyyy year; mm month; dm day; }\n"
 "alias unit { wd wsday; w lweek; y year; m month; md day; }\n"
 "format wdmyl \"{wsday:ws} |{day} |{month:m} |{year}| {lweek:lit}\";\n"
 "format wdmyl_a \"{wsday:ws:a} |{day} |{month:m:a} |{year}| {lweek:lit:a}\";\n"
 "format wly \"{wsday:ws}, |{lweek:lit} |{year}\";\n"
 "format wly_a \"{wsday:ws:a}, |{lweek:lit:a} |{year}\";\n"
 "format dwy \"{wsday:ws}, |{lweek:lit} |{year}\";\n"
 "format dwy_a \"{wsday:ws:a}, |{lweek:lit:a} |{year}\";\n"
 "format ydw \"{year}| {wsday:ws},| {lweek:lit}\";\n"
 "format ydw_a \"{year}| {wsday:ws:a},| {lweek:lit:a}\";\n"
 "preferred wdmyl;\n"
 "}\n"
 "scheme jlit {\n"
