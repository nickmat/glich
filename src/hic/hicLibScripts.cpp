...
glich::StdStrMap glich::hics_default_scripts = {
 ...
 "};\n"
 "lexicon yy_element {\n"
 "name \"Chinese Year Yin/Yang Elements\";\n"
 "fieldname stem;\n"
 "lang en;\n"
 "pseudo Element;\n"
 "tokens {\n"
 ...
 "};\n"
 "grammar c {\n"
 "fields year month lmonth day cycle segyear;\n"
 "calculated clmonth stem branch;\n"
 "rank year month lmonth day;\n"
 "lexicons lmon fs cstem cbrch animal yy_element;\n"
 "alias pseudo { yy year; mm month; lm lmonth; cm clmonth; dd day; cc cycle; sy segyear; ss stem; bb branch; };\n"
 "alias unit { y year; m month; lm lmonth; d day; c cycle; sy segyear; cm clmonth; s stem; b branch; };\n"
 "function calculate {\n"
 "stem = (segyear - 1) mod 10 + 1;\n"
 "branch = (segyear - 1) mod 12 + 1;\n"
 "clmonth = @if(lmonth=1, null, 2);\n"
 "result = this;\n"
 "};\n"
 "function fixed {\n"
 "if stem <> null and branch <> null {\n"
 "segyear = ((stem - branch) mod 12) * 5 + stem;\n"
 "};\n"
 "if cycle <> null and segyear <> null {\n"
 "year = (cycle - 1) * 60 + segyear;\n"
 "};\n"
 "clmonth = @if(lmonth=1, null, 2);\n"
 "stem = (segyear - 1) mod 10 + 1;\n"
 "branch = (segyear - 1) mod 12 + 1;\n"
 ...
 "format elem_anim {\n"
 "inout \"{year} The {:stem:yy_element}-{:branch:animal} Year| {lmonth:lmon}| {month}| Day {day}\";\n"
 "separators \"-,:\";\n"
 "};\n"
 "format cymld {\n"
 ...
 "rank cycle segyear month clmonth day;\n"
 "functions { fixed cycle_to_year; };\n"
 "};\n"
 "format cylmd_s {\n"
 ...
 "};\n"
 "format full {\n"
 "inout \"Cycle: {cycle}|, Year: {stem:cstem}-{branch:cbrch::l} ({segyear})|, {lmonth:lmon}:| {month}|, Day: {day}\";\n"
 "rank cycle month day;\n"
 "separators \",-\";\n"
 "functions { fixed cycle_to_year; };\n"
 "};\n"
 "format animal_f \"(Cycle {cycle})| Year of the {branch:animal} {segyear}|, {lmonth:lmon}| {month}| Day {day}\";\n"
 "preferred ymld;\n"
 "};\n"
 "scheme c {\n"
 "name \"Chinese Beta 1\";\n"
