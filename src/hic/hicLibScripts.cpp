...
glich::StdStrMap glich::hics_default_scripts = {
 ...
 "};\n"
 "lexicon rptd {\n"
 "name \"Repeated Date for repeated\";\n"
 "inherit rpt;\n"
 "fieldname repeated;\n"
 "};\n"
 "grammar je {\n"
 ...
 "format dmye_f \"{day} |{month:m} |{ceyear} |{ce:ce}\";\n"
 "format wdmye_f \"{wday:w} |{day} |{month:m} |{ceyear} |{ce:ce}\";\n"
 ...
 "format dmys_f \"{day} |{month:m} |{year} |{scheme:jg}\";\n"
 "format mdys \"{month:m:a} |{day}, |{year} |{scheme:jg:a}\";\n"
 "format mdys_f \"{month:m} |{day}, |{year} |{scheme:jg}\";\n"
 "preferred dmy;\n"
 "};\n"
 "scheme ay {\n"
 ...
 "result = this;\n"
 "};\n"
 "format dmy_a \"{day} |{month:frm:a} |{year}\";\n"
 "format dmy \"{day} |{month:frm} |{year}\";\n"
 "format ymd \"{year}| {month:frm}| {day}\";\n"
 "format cdmy {\n"
 "inout \"{cday:frcomp} |{nmday} |{nmonth:frnm} |{year}\";\n"
 "rank year nmonth nmday;\n"
 "functions { required required_from_comp; };\n"
 "};\n"
 "format cdmy_a {\n"
 "inout \"{cday:frcomp:a} |{nmday} |{nmonth:frnm:a} |{year}\";\n"
 "rank year nmonth nmday;\n"
 "functions { required required_from_comp; };\n"
 "};\n"
 "format std {\n"
 "inout \"{cday:frcomp} |{nmday} |{nmonth:frnm} |an {year::rn}\";\n"
 "rank year nmonth nmday;\n"
 "functions { required required_from_comp; };\n"
 "};\n"
 "format dcdmy {\n"
 "inout \"{dday:frdd} |{cday:frcomp} |{nmday} |{nmonth:frnm} |{year}\";\n"
 "rank year nmonth nmday;\n"
 "functions { required required_from_comp; };\n"
 "};\n"
 "format dcdmy_a {\n"
 "inout \"{dday:frdd:a} |{cday:frcomp:a} |{nmday} |{nmonth:frnm:a} |{year}\";\n"
 "rank year nmonth nmday;\n"
 "functions { required required_from_comp; };\n"
 "};\n"
 "format wcdmy {\n"
 "inout \"{wday:w}, |{cday:frcomp} |{nmday} |{nmonth:frnm} |{year}\";\n"
 "rank year nmonth nmday;\n"
 "functions { required required_from_comp; };\n"
 "};\n"
 "format wcdmy_a {\n"
 "inout \"{wday:w:a}, |{cday:frcomp:a} |{nmday} |{nmonth:frnm:a} |{year}\";\n"
 "rank year nmonth nmday;\n"
 "functions { required required_from_comp; };\n"
 "};\n"
 "format gedcom \"{day} |{month:frm:a:u} |{year}\";\n"
 "preferred dmy;\n"
 "};\n"
 "scheme fr {\n"
 "name \"French Republic\";\n"
 ...
 "};\n"
 "lexicon lmon {\n"
 "name \"Regular or Leap month\";\n"
 "fieldname lmonth;\n"
 "lang en;\n"
 "pseudo LeapMon, LM;\n"
 "tokens {\n"
 "1, \"Regular Month\", \"Regular\";\n"
 "2, \"Leap Month\", \"Leap\";\n"
 "};\n"
 "};\n"
 "lexicon lmon2 {\n"
 "name \"Regular or Leap month for clmonth\";\n"
 "inherit lmon;\n"
 "fieldname clmonth;\n"
 "};\n"
 "grammar c {\n"
 "name \"Chinese year count formats\";\n"
 "fields year month lmonth day cycle segyear stem branch element polarity;\n"
 "rank year month lmonth day;\n"
 "calculated clmonth;\n"
 "alias pseudo { dd day; mm month; lm lmonth; yyyy year; cc cycle; sy segyear; ss stem; bb branch; e element; y yinyang; pol polarity; cl clmonth; };\n"
 "alias unit { d day; m month; lm lmonth; y year; c cycle; sy segyear; s stem; b branch; e element; p polarity; cl clmonth; };\n"
 ...
 "rank year month day;\n"
 "functions {\n"
 "calculated calculate_clmonth;\n"
 "required required_from_clmonth;\n"
 "};\n"
 "};\n"
 "format animal \"{year} Year of the {:branch:animal}|, {lmonth:lmon}| {month}| Day {day}\";\n"
 "format elem_anim {\n"
 "inout \"{year} The {:polarity:yinyang}-{:element:element}-{:branch:animal} Year| {lmonth:lmon}| {month}| Day {day}\";\n"
 "separators \",-\";\n"
 "};\n"
 "preferred ymld;\n"
 "};\n"
 "grammar ccsy {\n"
 "name \"Chinese cycle and segyear formats\";\n"
 "inherit c;\n"
 "format cymld {\n"
 ...
 "};\n"
 "format cylmd {\n"
 "inout \"{cycle}| {segyear}| {clmonth:lmon2:a}| {month}| {day}\";\n"
 ...
 "};\n"
 "format cylmd_s {\n"
 "inout \"{cycle}| {stem:cstem}|-{branch:cbrch::l}|, {clmonth:lmon2:a}| {month}| {day}\";\n"
 ...
 "};\n"
 "format cylmd_f {\n"
 "inout \"Cycle: {cycle}| Year: {:stem:cstem}-{:branch:cbrch::l} ({segyear})| {clmonth:lmon2:a}| Month: {month}| Day: {day}\";\n"
 "rank cycle segyear month day;\n"
 "separators \",-\";\n"
 "functions {\n"
 "calculated calculate_clmonth;\n"
 ...
 "};\n"
 "format cy_animal {\n"
 "inout \"(Cycle {cycle})| Year of the {:branch:animal} {segyear}| {lmonth:lmon}| {month}| Day {day}\";\n"
 "rank cycle segyear month lmonth day;\n"
 "};\n"
 "preferred cymld;\n"
 "};\n"
