...
SValue Script::function_call()
{
    enum f {
        ...
        f_has_shorthand, f_fmt_rules, f_fmt_object, f_sch_object
    };
    const static std::map<string, f> fmap = {
        ...
        { "has_shorthand", f_has_shorthand },
        { "fmt_rules", f_fmt_rules }, { "fmt:object", f_fmt_object }, { "sch:object", f_sch_object }
    };
